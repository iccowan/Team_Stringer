...
<body>
    <p>Dear {{ $user->name }},</p>
    <br>
    <p>You have been invited by {{ $coach->name }} to join the Team Stringer with the team, {{ $coach->team_name }}! Please follow the instructions below to finish setting up your account.</p>
    <br>
